 ...
 * @public
 */
HM.prototype.pack = function (content, namespace) {
    ...
    return this.walker(content, this.options.namespace).organize().addBoxWrapper();
};
...
HM.prototype.toBuffer = function () {
    return new Buffer(this.contents, 'utf8');
};

HM.prototype.uglify = function (config) {
...
HM.prototype.packFromFile = function (packageName, namespace) {
 ...
 * @private
 */
HM.prototype.addBoxWrapper = function (content, type) {
...
HM.prototype.walker = function (content, packageName) {
